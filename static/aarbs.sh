...
# Adam's Auto Rice Boostrapping Script (AARBS)
# License: GNU GPLv3

### OPTIONS AND VARIABLES ###

dotfilesrepo="https://github.com/adamkagdi/archrice.git"
progsfile="https://raw.githubusercontent.com/adamkagdi/AARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Adam's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Adam" 10 60
...
echo "%wheel ALL=(ALL:ALL) NOPASSWD: /usr/bin/shutdown,/usr/bin/reboot,/usr/bin/systemctl suspend,/usr/bin/wifi-menu,/usr/bin/mount,/usr/bin/umount,/usr/bin/pacman -Syu,/usr/bin/pacman -Syyu,/usr/bin/pacman -Syyu --noconfirm,/usr/bin/loadkeys,/usr/bin/pacman -Syyuw --noconfirm,/usr/bin/pacman -S -u -y --config /etc/pacman.conf --,/usr/bin/pacman -S -y -u --config /etc/pacman.conf --" >/etc/sudoers.d/01-AARBS-cmds-without-password
